...
const ConfirmationPage = ({ name }) => {
  const handleDownload = () => {
    ...
    link.href = `${process.env.PUBLIC_URL}/assets/invitation.pdf`; // تأكد من أن المسار صحيح
    ...
    >
      <div className="bg-opacity-80 p-6 rounded-lg shadow-lg max-w-md w-full text-center">
        ...
        <a
          ...
          className="inline-block mt-4 px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 transition cursive-font"
        >
          <Typewriter
            text="Location"
            typeSpeed={100}
